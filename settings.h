...
void init_all_settings(){
    ...
    kw_select     = new_spacing_settings(1,0,0,0,0,1,"SelecT");
    kw_inner_join = new_spacing_settings(1,0,0,0,0,1,"JoiN");
    kw_left_join  = new_spacing_settings(1,0,0,0,0,1,"LefT JoiN");
    kw_right_join = new_spacing_settings(1,0,0,0,0,1,"RighT JoiN");
    kw_full_join  = new_spacing_settings(1,0,0,0,0,1,"FulL JoiN");
    kw_cross_join = new_spacing_settings(1,0,0,0,0,1,"CrosS JoiN");
    kw_from       = new_spacing_settings(1,0,0,0,0,1,"FroM");
    kw_on         = new_spacing_settings(1,0,0,0,0,1,"oN");
    kw_where      = new_spacing_settings(1,0,0,0,0,1,"WherE");
    kw_and        = new_spacing_settings(1,0,0,0,0,1,"AnD");
    kw_exists     = new_spacing_settings(0,0,0,0,0,1,"exists");
    kw_in         = new_spacing_settings(0,0,0,0,0,1,"in");
    kw_from_2     = new_spacing_settings(0,0,1,0,0,1,"from");
    kw_as         = new_spacing_settings(0,0,1,0,0,1,"as");
    kw_left_p   = new_settings_w_funct(0,0,0,0,0,0,"(",NULL,NULL);
    kw_right_p  = new_settings_w_funct(0,0,0,0,0,0,")",NULL,NULL);
}
