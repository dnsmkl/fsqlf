...
int create_config_file( char* config_file_name ) {
    ...
    #define T_KW_SETTINGS_MACRO( NAME,nlb,tb,sb,nla,ta,sa,TEXT , ... ) \
        fprintf(config_file, "%-24s ", QUOTE(NAME) ); \
        fprintf(config_file, "%s"  , QUOTE(nlb) ); \
        fprintf(config_file, " %6s", QUOTE(tb) ); \
        fprintf(config_file, " %6s", QUOTE(sb) ); \
        fprintf(config_file, " %6s", QUOTE(nla) ); \
        fprintf(config_file, " %6s", QUOTE(ta) ); \
        fprintf(config_file, " %6s", QUOTE(sa) ); \
        fprintf(config_file, "\n") ;
